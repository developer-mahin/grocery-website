...
const ProductCard = ({ product }) => {
    ...
    const { title, image, ratings, price, _id } = product;
            ...
            <div data-aos="zoom-in" className='border rounded shadow cursor-pointer hover:shadow-lg duration-300'>
                ...
                <div className='p-4'>
                    ...
                    <div className='py-2 flex items-center justify-between'>
                        ...
                        <Link to={`/booking/${_id}`} className='flex items-center gap-1 bg-green-100 px-3 py-2 text-sm rounded-md font-semibold text-green-500 hover:-translate-y-2 duration-500'>
