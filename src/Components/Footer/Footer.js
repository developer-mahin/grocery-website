...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#e7e7e7e5] text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <div className="uppercase text-gray-800 font-semibold">Social media</div>
            ...
            <div className="py-6 text-sm text-center text-gray-700 font-medium border-t-2 border-gray-700">© 2023 Grocery. All rights reserved.</div>
        </footer>
    );
};
